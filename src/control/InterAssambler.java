...
public class InterAssambler {
    ...
    public InterAssambler(DefaultTableModel dtmLexemas) {
        this.dtm = dtmLexemas;
    ...
    public String leerSentencias(ArrayList<String> lista) {
        ...
        for (int i = 0; i < tamaño; i++) {
            ...
            String lexema;
            if (lista == null) {
                lexema = dtm.getValueAt(i, 0).toString().replace("\"", "\'");
            } else {
                lexema = lista.get(i).replace("\"", "\'");
            }
            ...
            if (lexema.equals("si")) {
                ...
                do {
                    ...
                    if (lista == null) {
                        lexemaSiguiente = dtm.getValueAt(i, 0).toString().replace("$", "").replace("\"", "\'");
                    } else {
                        lexemaSiguiente = lista.get(i).replace("$", "").replace("\"", "\'");
                    }
                ...
                asignacion.add(lexema.replace("$", "").replace("\"","\'"));
                asignacion2.add(lexema.replace("$", "").replace("\"","\'"));
                do {
                    i++;
                    String lexe;
                    if (lista == null) {
                        lexe = dtm.getValueAt(i, 0).toString().replace("$", "").replace("\"","\'");
                    } else {
                        lexe = lista.get(i).replace("$", "").replace("\"","\'");
                    }
                    if (lexe.equals(";")) {
                        band = false;
                    } else {
                        asignacion.add(lexe.replace("$", "").replace("\"","\'"));
                        asignacion2.add(lexe.replace("$", "").replace("\"","\'"));
                    }
                } while (band);
                ...
                if (lexema.equals("escribir")) {
                    boolean ban = true;
                    codigoCompleto += lexema.replace("\"", "\'");
                    do {
                        i++;
                        String lexi = dtm.getValueAt(i, 0).toString().replace("\"", "\'");
                        codigoCompleto += lexi;
                        if (lexi.equals(";")) {
                            codigoCompleto += "\n";
                            break;
                ...
                if (lexema.equals("escribir")) {
                    boolean ban = true;
                    codig += lexema.replace("\"", "\'");
                    do {
                        i++;
                        String lexi = lista.get(i).replace("\"","\'");
                        codig += lexi;
                        if (lexi.equals(";")) {
                            codig += "\n";
                            break;
                            ...
                            for (int j = 0; j < s1.size(); j++) {
                                ...
                                if (lex.equals(";")) {
                                    //if (sent.get(0).startsWith("$") && sent.get(1).equals("=") || sent.get(0).equals("int") || sent.get(0).equals("cad") || sent.get(0).equals("doble")) {
                                      if (Character.isLetter(sent.get(0).charAt(0)) && sent.get(1).equals("=") || sent.get(0).equals("int") || sent.get(0).equals("cad") || sent.get(0).equals("doble")) {  
                                        boolean band = true;
                                        ArrayList asignacion = new ArrayList();
                                        int h = 0;
                                        do {
                                            String lexe;
                                            lexe = sent.get(h).replace("$", "").replace("\"","\'");
                                            if (lexe.equals(";")) {
                                                band = false;
                                            }
                                            asignacion.add(lexe);
