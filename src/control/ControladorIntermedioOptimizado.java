 ...
 * @author GarciHard
 */
public class ControladorIntermedioOptimizado {
    ...
    public ControladorIntermedioOptimizado(DefaultTableModel dtmLexemas) {
        this.dtm = dtmLexemas;
        ...
        for (int i = 0; i < tamaño; i++) {
            ...
            if (lexema.equals("si")) {
                ...
                if (asignacion.size() > 4) {
                    if (lista == null) {
                        codigoCompleto += temporalesConArreglo(asignacion);
                    } else {
                        codig += temporalesConArreglo(asignacion);
                    }
                } else if (lista == null) {
